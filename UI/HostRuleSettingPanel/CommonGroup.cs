...
public class CommonGroup : MonoBehaviour
{
    ...
    [SerializeField] private ToggleOption goastCanSeeRoleOption = null;
    ...
    public PhotonHashTable OptionSetting
    {
        get
        {
            ...
            optionSetting.Add(CustomProperties.GOAST_CAN_SEE_ROLE, goastCanSeeRoleOption.OptionValue);
    ...
    public void SetGroup(PhotonHashTable roomSetting)
    {
        ...
        goastCanSeeRoleOption.InitOption((bool)roomSetting[CustomProperties.GOAST_CAN_SEE_ROLE]);
    }
